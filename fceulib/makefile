...
UTILSOBJECTS= utils/general.o utils/memory.o utils/crc32.o utils/guid.o utils/endian.o utils/md5.o utils/xstring.o 
...
FCEUOBJECTS=cart.o config.o debug.o drawing.o emufile.o fceu.o fds.o file.o filter.o ines.o input.o movie.o palette.o ppu.o sound.o state.o unif.o video.o vsuni.o wave.o x6502.o
