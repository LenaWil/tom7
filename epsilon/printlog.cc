...
NamedEntry entries_csharp[] = {
  { INIT(1.1102230246251565E-16), 1 },
  { INIT(10e-6), 1 },
  { INIT(1.401298E-45d), 1 },
  { INIT(1e-100), 1 },
  { INIT(10e-7), 1 },
  { INIT(1E-8), 1 },
  { INIT(700), 1 },
  ...
  { INIT(0.000001f), 1 },
  { INIT(30), 1 },
  { INIT(216.0 / 24389.0), 1 },
  { INIT(2.7105054312137610850186320021749e-20), 1 },
  { INIT(0.01d), 1 },
  { INIT(1e-13), 1 },
  { INIT(.00001), 1 },
  { INIT(.000001d), 1 },
  { INIT(0.1d), 1 },
  { INIT(2.22044604925031E-15), 1 },
  { INIT(1e-4), 1 },
  { INIT(0.05), 1 },
  { INIT(4.9406564584124650e-324d), 1 },
  { INIT(5.0), 1 },
  { INIT(.0000000001), 1 },
  { INIT(0.0000001f), 1 },
  { INIT(1 / 100000), 2 },
  { INIT(1.0/1024.0), 2 },
  { INIT(216. / 24389.), 2 },
  { INIT(0.000000000001), 2 },
  { INIT(1.0e-5), 2 },
  { INIT(1E-5), 2 },
  { INIT(1E-13), 2 },
  { INIT(1e-7), 2 },
  { INIT(0.000000000000000000001), 2 },
  { INIT(1.0-18), 2 },
  { INIT(3.141592653589 * 0.01), 2 },
  { INIT(0.008856), 2 },
  { INIT(1E-11), 2 },
  { INIT(1e-14), 2 },
  { INIT(.001), 2 },
  ...
  { INIT(1E-30), 3 },
  { INIT(1.0e-6), 3 },
  { INIT(0.000000000001), 3 },
  { INIT(1E-10), 3 },
  { INIT(1E-7), 3 },
  { INIT(1), 3 },
  { INIT(std::numeric_limits<double>::epsilon()), 4 },
  { INIT(2.2250738585072014E-16), 4 },
  { INIT(4.9406564584124654E-324), 4 },
  { INIT(1.0E-7), 4 },
  { INIT(0.0000000001), 5 },
  { INIT(0.1), 5 },
  { INIT(1e-9), 5 },
  { INIT(1E-12), 5 },
  { INIT(std::numeric_limits<double>::epsilon()*1e10), 5 },
  { INIT(0.0000000000000002220446049250313080847263336181640625), 6 },
  { INIT(4.94065645841247E-324), 6 },
  { INIT(1e-12), 7 },
  { INIT(std::numeric_limits<double>::epsilon()), 7 },
  { INIT(0.00000001), 8 },
  { INIT(1e-3), 9 },
  { INIT(4.9406564584124650E-324), 12 },
  { INIT(1e-5), 13 },
  { INIT(1.192093E-07), 13 },
  { INIT(0.01), 14 },
  { INIT(0.000000000000001), 14 },
  { INIT(1e-6), 16 },
  { INIT(0.0000001), 16 },
  { INIT(4.9406564584124650e-324), 21 },
  { INIT(0.000001), 26 },
  { INIT(1e-10), 30 },
  { INIT(0.00000153), 34 },
  { INIT(1e-8), 38 },
  { INIT(0.00001), 51 },
  { INIT(0.0001), 83 },
  { INIT(2.2204460492503131e-016), 121 },
  { INIT(2.2204460492503131E-16), 131 },
  { INIT(0.001), 194 },
};

NamedEntry entries_js[] = {
  { INIT(0.2), 1 },
  { INIT(0.4), 1 },
  { INIT(0.0), 1 },
  { INIT(pow(10,-5)), 1 },
