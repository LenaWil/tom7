...
FCEUOBJECTS=cart.o config.o drawing.o emufile.o fceu.o fds.o file.o filter.o ines.o input.o movie.o palette.o ppu.o sound.o state.o unif.o video.o vsuni.o wave.o x6502.o
