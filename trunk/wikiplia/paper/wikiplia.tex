...
% so that visual gag on ``capable'' doesn't appear at top of page
\vspace{10em}
\hyphenation{capable}
\subsection{Solution}
...
moniod\wcite{Free monoid} on the set of XML documents, and we seek
...
by a tower of source-to-source translations\wcite{Translation} on top
of a universally parseable semantic document in
XML\wciteshort{Category:ML programming language family} form.

The author\wcite{Author} doesn't think\wcite{Thought} much of
...
gross,\z\wcite{Gross} but not quite as gross as foie
gras,\z\wcite{Foie gras} which more or less has the word\wcite{Word}
``gross'' in its name\wcite{Name} so duh.\z\wcite{Duh}
